	...
	function Card:highlight(is_highlighted)
		...
		if  self.highlighted and self.config.center.rarity == "nic_plants" and self.area == G.zengarden then
			...
			self.children.use_button = UIBox({
				definition = Incognito.default_plant(self, {
					sell = true,
				}),
				config = {
					align = "cr",
	...
	Incognito.default_plant = function(card, args)
		local args = args or {}
		local sell = nil
		local use = nil
